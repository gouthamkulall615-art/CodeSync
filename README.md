...
SyncCanvas is a real-time collaborative code editor that allows multiple users to work on the same code simultaneously.

The project uses React, Canvas placeholder, Yjs, , Socket.IO, and y-socket.io to provide real-time synchronization between connected users.

## Features

- Real-time collaborative code editing
- Canvas placeholder integration
...
SyncCanvas uses Yjs as the underlying synchronization layer.
...
SyncCanvas consists of two primary applications.
...
The current version is an early collaboration-shell implementation.
...
SyncCanvas is currently under active development.

The core real-time collaboration engine is in place; canvas work will be added separately.
