  ...
  return (
    <nav className="w-full bg-[#0a0a0c] border-b border-zinc-800/60 px-6 py-3.5 flex items-center justify-between font-sans text-white">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* User Avatar */}
        <button className="w-9 h-9 rounded-full bg-zinc-800 border border-zinc-700 hover:border-zinc-500 overflow-hidden ml-1 flex items-center justify-center text-sm font-medium text-zinc-300 transition-colors">
          G
        </button>
      </div>
    </nav>
